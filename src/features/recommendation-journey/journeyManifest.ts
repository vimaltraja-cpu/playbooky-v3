...
export const journeyManifest: JourneyStage[] = [
  {
    ...
    output: ["challenge"],
    notes: [
      "Green-lit UI stage. HomepageComposerLayout is the approved composer source.",
      "Background: SiteBackgroundWash is included in the composer layout.",
      "Composer text persists into the internal journey and feeds Dynamic Diagnosis."
    ],
    audit: {
      ...
      knownIssues: [
        "Composer is green-lit as UI, but the broader product shell outside /internal/journey is not the public app yet."
      ],
      ...
      supportingComponentSources: [
        ...
        "components/ui/site-background-wash/config.ts",
        "components/ui/site-background-wash/site-background-wash.css",
        "src/features/recommendation-journey/journeyState.ts"
      ]
    }
  },
  {
    ...
    componentSourcePaths: [
      ...
      "src/features/recommendation-journey/matchChallengeToDiagnosis.ts"
    ],
    sourceStatus: "approved",
    responsiveStatus: "approved",
    handoffStatus: "approved",
    ...
    notes: [
      "Green-lit UI stage. DiagnosisQuestionScreen is the approved diagnosis source.",
      "Background: SiteBackgroundWash is owned by the diagnosis screen shell.",
      "Dynamic Diagnosis reviews Composer text, pre-fills matched answers, and asks only remaining questions.",
      "Diagnosis answers persist into the journey handoff for recommendation loading."
    ],
    audit: {
      candidateOlderVersions: [
      ...
      knownIssues: [
        "Dynamic Diagnosis currently uses a Phase 1 deterministic matcher, not full AI extraction.",
        "Diagnosis Engine / Decision Engine recommendation generation is still fixture-driven downstream."
      ],
      reasonThisIsLatestVersion:
      ...
      supportingComponentSources: [
        ...
        "src/features/recommendation-journey/journeyState.ts",
        "src/features/recommendation-journey/matchChallengeToDiagnosis.ts",
        "docs/09-product/diagnosis/dynamic-diagnosis.md"
      ]
    }
  },
  {
