...
const activeHref =
  "/design-system/product-system/libraries/building-block-library";

export default async function BuildingBlockLibraryPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-[#ededed]">
      <div className="grid min-h-screen w-full grid-cols-1 lg:grid-cols-[var(--portal-sidebar-width)_minmax(0,1fr)]">
        ...
        <LibrariesWorkspace activeHref={activeHref} dataset={dataset} mode="blocks" />
      </div>
    </main>
  );
}
