...
import { ActivityLibraryShelvesPlayground } from "./ActivityLibraryShelvesPlayground";

export default async function ActivityLibraryShelvesPlaygroundPage() {
  ...
  return (
    <ActivityLibraryShelvesPlayground
