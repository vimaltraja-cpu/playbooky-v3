...
import {
  apertureRevealMeta,
  ApertureRevealConcept
} from "@/components/prototypes/activity-modal-motion-v3/concept-3-aperture-reveal/ApertureRevealConcept";
import { getV3PrototypeCards } from "@/components/prototypes/activity-modal-motion-v3/shared/prototype-cards";

export default function ActivityModalMotionV3ApertureRevealPage() {
