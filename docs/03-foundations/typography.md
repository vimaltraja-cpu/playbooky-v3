...
PlayBooky uses two complementary type families:

* **Geist** is the operational product voice.
* **Newsreader** is the editorial display voice.

Geist supports clarity, speed, precision, scanning, controls, and dense product interfaces.

Newsreader supports warmth, reflection, confidence, and premium orientation moments.
...
* Use Geist for operational product typography.
* Use Newsreader only for approved editorial display moments.
...
* Use Newsreader for dense product UI, labels, controls, or body copy.

## Font Families

PlayBooky uses one primary sans-serif family, one editorial serif family, and one monospace family.
...
* Support product UI, documentation, Design Portal pages, headings, body text, labels, captions, controls, navigation, forms, cards, tables, dense interfaces, and builder surfaces.
* Provide clear letterforms, strong readability, and stable rendering across platforms.
* Give PlayBooky a modern, precise, AI-product feel.

Rules:

* Use the primary sans family for all product and portal interface text unless an approved semantic token specifies Newsreader.
* Use Geist for all interactive UI.
* Use Geist for body copy, labels, captions, controls, navigation, inputs, tables, cards, and dense operational surfaces.
* Do not introduce another sans-serif family.

### Editorial Serif

The editorial serif family is:

```text
Newsreader, Georgia, Cambria, "Times New Roman", serif
```

Purpose:

* Support rare editorial and reflective moments.
* Give PlayBooky warmth, confidence, and a premium facilitation tone.
* Create distinction between product operation and orientation moments.

Use Newsreader for:

* Homepage hero typography.
* Major page introductions.
* Recommendation hero moments.
* Empty states where reflection is needed.
* Editorial guidance moments.
* Large display typography.

Rules:

* Use Newsreader only through approved display typography tokens.
* Do not use Newsreader for body copy.
* Do not use Newsreader for labels, buttons, navigation, inputs, cards, tables, forms, captions, metadata, or dense product UI.
* Do not use Newsreader below heading-level scale unless a future component owner documents a specific exception.
* Do not introduce another serif family.
...
| Token                               | Family     | Value                                                                                        |
| ----------------------------------- | ---------- | -------------------------------------------------------------------------------------------- |
| `typography.primitive.family.sans`  | Geist      | `Geist, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif` |
| `typography.primitive.family.serif` | Newsreader | `Newsreader, Georgia, Cambria, "Times New Roman", serif`                                     |
| `typography.primitive.family.mono`  | Mono       | `"SFMono-Regular", Consolas, "Liberation Mono", Menlo, monospace`                            |

Rules:

* Product pages must consume typography through semantic tokens, not primitive font tokens directly.
* Primitive family tokens exist so semantic typography tokens can reference approved families.
* Additional font-family primitive tokens must not be created without updating this document and the token source.
...
Display text is reserved for primary page, portal, or editorial orientation moments where the text is the main orientation signal.

Display tokens use Newsreader.

| Token                  | Desktop |   Tablet |  Mobile | Line height | Weight | Letter spacing | Font family | Purpose                                              |
| ---------------------- | ------: | -------: | ------: | ----------: | -----: | -------------: | ----------- | ---------------------------------------------------- |
| `typography.display.1` |    4rem |  3.25rem |  2.5rem |         1.1 |    600 |              0 | Newsreader  | Largest page-level display title.                    |
| `typography.display.2` | 3.25rem |  2.75rem | 2.25rem |         1.1 |    600 |              0 | Newsreader  | Strong page title or major portal introduction.      |
| `typography.display.3` | 2.75rem | 2.375rem |    2rem |        1.15 |    600 |              0 | Newsreader  | Smaller display title for constrained page contexts. |

Rules:

* Use display text only once per page or major portal view.
* Use display text only for editorial or orientation moments.
* Do not use display tokens inside cards, sidebars, tables, dense panels, forms, controls, or repeated items.
* Display text must wrap cleanly on mobile without overlapping neighbouring content.
* Display tokens must use `typography.primitive.family.serif`.

## Heading Scale

Headings structure content and support scanning.

Heading tokens use Geist.

| Token                  |  Desktop |    Tablet |    Mobile | Line height | Weight | Letter spacing | Font family | Purpose                                               |
| ---------------------- | -------: | --------: | --------: | ----------: | -----: | -------------: | ----------- | ----------------------------------------------------- |
| `typography.heading.1` |  2.25rem |      2rem |   1.75rem |         1.2 |    600 |              0 | Geist       | Page H1 when display text is not used.                |
| `typography.heading.2` | 1.875rem |   1.75rem |    1.5rem |         1.2 |    600 |              0 | Geist       | Major section heading.                                |
| `typography.heading.3` |   1.5rem |  1.375rem |   1.25rem |        1.25 |    600 |              0 | Geist       | Subsection heading.                                   |
| `typography.heading.4` |  1.25rem | 1.1875rem |  1.125rem |         1.3 |    600 |              0 | Geist       | Panel or grouped-content heading.                     |
| `typography.heading.5` | 1.125rem | 1.0625rem |      1rem |        1.35 |    600 |              0 | Geist       | Compact heading inside dense content.                 |
| `typography.heading.6` |     1rem |      1rem | 0.9375rem |        1.35 |    600 |              0 | Geist       | Small heading, table group, or compact label heading. |
...
* Heading tokens must use `typography.primitive.family.sans`.

## Body Scale

Body text supports reading, explanation, and product content.

Body tokens use Geist.

| Token                     |   Desktop |    Tablet |    Mobile | Line height | Weight | Letter spacing | Font family | Purpose                                                 |
| ------------------------- | --------: | --------: | --------: | ----------: | -----: | -------------: | ----------- | ------------------------------------------------------- |
| `typography.body.large`   |  1.125rem | 1.0625rem |      1rem |         1.6 |    400 |              0 | Geist       | Introductory paragraphs and important explanatory text. |
| `typography.body.default` |      1rem |      1rem |      1rem |         1.6 |    400 |              0 | Geist       | Default readable body copy.                             |
| `typography.body.compact` | 0.9375rem | 0.9375rem | 0.9375rem |        1.55 |    400 |              0 | Geist       | Dense interface body copy.                              |
| `typography.body.small`   |  0.875rem |  0.875rem |  0.875rem |         1.5 |    400 |              0 | Geist       | Secondary body copy and short supporting text.          |
...
* Body tokens must use `typography.primitive.family.sans`.

## Label Scale

Labels identify controls, navigation items, filters, metadata groups, and short interface actions.

Label tokens use Geist.

| Token                      |   Desktop |    Tablet |    Mobile | Line height | Weight | Letter spacing | Font family | Purpose                                                |
| -------------------------- | --------: | --------: | --------: | ----------: | -----: | -------------: | ----------- | ------------------------------------------------------ |
| `typography.label.large`   |      1rem |      1rem |      1rem |        1.35 |    500 |              0 | Geist       | Prominent control labels and navigation labels.        |
| `typography.label.default` |  0.875rem |  0.875rem |  0.875rem |        1.35 |    500 |              0 | Geist       | Default labels, buttons, tabs, chips, and form labels. |
| `typography.label.small`   | 0.8125rem | 0.8125rem | 0.8125rem |        1.35 |    500 |              0 | Geist       | Compact labels and dense metadata labels.              |
...
* Label tokens must use `typography.primitive.family.sans`.

## Caption Scale

Captions support metadata, helper text, timestamps, short notes, and secondary explanations.

Caption tokens use Geist.

| Token                        |   Desktop |    Tablet |    Mobile | Line height | Weight | Letter spacing | Font family | Purpose                                                           |
| ---------------------------- | --------: | --------: | --------: | ----------: | -----: | -------------: | ----------- | ----------------------------------------------------------------- |
| `typography.caption.default` | 0.8125rem | 0.8125rem | 0.8125rem |        1.45 |    400 |              0 | Geist       | Default caption, helper text, and metadata.                       |
| `typography.caption.small`   |   0.75rem |   0.75rem |   0.75rem |        1.45 |    400 |              0 | Geist       | Short timestamps, compact metadata, and non-critical helper text. |
...
* Caption tokens must use `typography.primitive.family.sans`.
...
* Test Newsreader display wrapping separately because serif display text has different rhythm and width behaviour from Geist.
...
| ---------------------------- | ----------------------------------- | ------------------------------------------- | -------------------------------------- | ------------------------------------------ | -------------------------------------- | ------------------------- |
| `typography.display.1`       | `typography.primitive.family.serif` | `typography.primitive.size.display-1`       | `typography.primitive.weight.semibold` | `typography.primitive.line-height.tight`   | `typography.primitive.tracking.normal` | Largest display title.    |
| `typography.display.2`       | `typography.primitive.family.serif` | `typography.primitive.size.display-2`       | `typography.primitive.weight.semibold` | `typography.primitive.line-height.tight`   | `typography.primitive.tracking.normal` | Secondary display title.  |
| `typography.display.3`       | `typography.primitive.family.serif` | `typography.primitive.size.display-3`       | `typography.primitive.weight.semibold` | `typography.primitive.line-height.heading` | `typography.primitive.tracking.normal` | Compact display title.    |
...
* Display tokens must use Newsreader.
* Heading, body, label, and caption tokens must use Geist.
* Code tokens must use the approved monospace family.
...
* Newsreader display text must be tested at mobile widths to ensure it remains readable and does not create awkward wrapping.
...
* Use Newsreader only where slower, more reflective reading is intentional.
* Do not use Newsreader for long-form reading unless a future editorial content owner defines that pattern.

## Usage Rules

Use typography tokens by role:

* Use display tokens for rare page-level editorial orientation.
...
* Use Geist for product interaction.
* Use Geist for operational clarity.
* Use Geist for repeated surfaces.
* Use Geist for dense product areas.
* Use Newsreader for emotional, reflective, or editorial display moments.
* Use Newsreader when the user is arriving, orienting, or being guided.
* Do not use Newsreader when the user is filling, choosing, scanning, comparing, dragging, building, editing, or submitting.
...
* Use display tokens for rare editorial moments.
* Use Geist for product UI.
* Use Newsreader for large display moments.
...
* Don't use Newsreader for buttons, inputs, labels, metadata, tables, or dense UI.
* Don't introduce another display font.
...
* Default to Geist for product typography.
* Use Newsreader only for approved editorial or orientation moments.
* Explain why Newsreader is appropriate before proposing it outside display typography.

When choosing typography:

* If the user is reading, navigating, scanning, comparing, selecting, dragging, building, editing, or submitting, use Geist.
* If the user is arriving, reflecting, being inspired, or being oriented at a major page moment, Newsreader may be used through display tokens.
...
* Use Newsreader for product controls, labels, dense UI, or body copy.
* Suggest additional fonts unless the design system owner explicitly requests a typography review.
...
* Newsreader is used only for approved display moments.
* Geist is used for product UI, body, headings, labels, captions, and controls.
...
* Geist is defined as the primary sans-serif product font.
* Newsreader is defined as the editorial display font.
* Display, heading, body, label, and caption scales are defined.
* Display tokens use Newsreader.
* Heading, body, label, and caption tokens use Geist.
